...
"%~dp0..\dependencies/sed.exe" -i -e "s/wipe_//g" "%~dp0..\_ark\track\score\score.dta"
"%~dp0..\dependencies/sed.exe" -i -e "s/gold_star_//g" "%~dp0..\_ark\track\score\score.dta"
"%~dp0..\dependencies/sed.exe" -i -e "s/star_power_//g" "%~dp0..\_ark\track\score\score.dta"
"%~dp0..\dependencies/sed.exe" -i -e "s/score_meter_//g" "%~dp0..\_ark\track\score\score.dta"
