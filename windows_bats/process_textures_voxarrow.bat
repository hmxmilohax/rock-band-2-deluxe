...
FOR /F "tokens=*" %%G IN ('dir /b *.png') DO "%~dp0..\dependencies/windows/superfreq_wii.exe" png2tex "%~dp0..\custom_textures\voxarrow/%%G" "%~dp0..\_ark\track\voxarrow\gen\%%~nG.png_wii" --platform wii --miloVersion 25
del sed* /a /s
