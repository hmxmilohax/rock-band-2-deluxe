...
FOR /F "tokens=*" %%G IN ('dir /b *.png') DO "%~dp0..\dependencies/windows/superfreq_wii.exe" png2tex "%~dp0..\custom_textures\overdrive_bar/%%G" "%~dp0..\_ark\track\overdrive_bar\gen\%%~nG.png_wii" --platform wii --miloVersion 25
del sed* /a /s
