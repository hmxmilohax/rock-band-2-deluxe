del /f "%~dp0..\_ark\track\smashers\smashers.dta"
mkdir "%~dp0..\_tmp"
...
move "%~dp0..\custom_textures\smashers\smashers.dta" "%~dp0..\_ark\track\smashers\smashers.dta"
"%~dp0..\dependencies/sed.exe" -i -e "s/square_smasher_bright_//g" "%~dp0..\_ark\track\smashers\smashers.dta"
"%~dp0..\dependencies/sed.exe" -i -e "s/smasher_//g" "%~dp0..\_ark\track\smashers\smashers.dta"
"%~dp0..\dependencies/sed.exe" -i -e "s/color_//g" "%~dp0..\_ark\track\smashers\smashers.dta"
...
FOR /F "tokens=*" %%G IN ('dir /b *.png') DO "%~dp0..\dependencies/windows/superfreq.exe" png2tex "%~dp0..\custom_textures\smashers/%%G" "%~dp0..\_tmp\%%~nG.bmp_ps2"
cd "%~dp0..\_tmp"
FOR /F "tokens=*" %%G IN ('dir /b *.bmp_ps2') DO "%~dp0..\dependencies/windows/superfreq.exe" tex2png "%~dp0..\_tmp/%%G" "%~dp0..\_tmp\%%~nG.png"
FOR /F "tokens=*" %%G IN ('dir /b *.png') DO "%~dp0..\dependencies/windows/superfreq.exe" png2tex "%~dp0..\_tmp/%%G" "%~dp0..\_ark\track\smashers\gen\%%~nG.png_ps2"
cd "%~dp0..\"
rmdir "%~dp0..\_tmp" /s /q