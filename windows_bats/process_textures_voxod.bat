...
"%~dp0..\dependencies/sed.exe" -i -e "s/player_meter_//g" "%~dp0..\_ark\track\voxod\voxod.dta"
"%~dp0..\dependencies/sed.exe" -i -e "s/long_//g" "%~dp0..\_ark\track\voxod\voxod.dta"
"%~dp0..\dependencies/sed.exe" -i -e "s/background_//g" "%~dp0..\_ark\track\voxod\voxod.dta"
FOR /F "tokens=*" %%G IN ('dir /b *.png') DO "%~dp0..\dependencies/magick/magick.exe" convert "%~dp0..\custom_textures\voxod/%%G" "%~dp0..\custom_textures\voxod\%%~nG.png"
