...
"%~dp0..\dependencies/sed.exe" -i -e "s/_emissive//g" "%~dp0..\_ark\track\spotlight\spotlight.dta"
...
FOR /F "tokens=*" %%G IN ('dir /b *.png') DO "%~dp0..\dependencies/windows/superfreq.exe" png2tex "%~dp0..\custom_textures\spotlight/%%G" "%~dp0..\_ark\track\spotlight\gen\%%~nG.png_xbox" --platform x360 --miloVersion 25
