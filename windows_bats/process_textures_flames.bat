...
cd "%~dp0..\_ark/track/flames/gen"
FOR /F "tokens=*" %%G IN ('dir /b *.png_xbox') DO python "%~dp0..\dependencies/swap_rb_art_bytes.py" "%~dp0..\_ark/track/flames/gen/%%G" "%~dp0..\_ark/track/flames/gen/%%~nG.png_ps3"