...
"%~dp0dependencies/sed.exe" -i -e "s/black_smasher_spec_//g" "%~dp0_ark\track\smashers\smashers.dta"
...
cd "%~dp0_ark/track/smashers/gen"
FOR /F "tokens=*" %%G IN ('dir /b *.png_xbox') DO python "%~dp0dependencies/swap_rb_art_bytes.py" "%~dp0_ark/track/smashers/gen/%%G" "%~dp0_ark/track/smashers/gen/%%~nG.png_ps3"
