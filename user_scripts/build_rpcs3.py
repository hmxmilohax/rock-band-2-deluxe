...
def validate_rpcs3_directory(rpcs3_directory):
    ...
    blus30147_folder_path = os.path.join(game_folder_path, "BLUS30147")
    ...
    if not os.path.exists(blus30147_folder_path):
        print("Rock Band 2 (BLUS30147) not detected in the provided rpcs3 directory. Creating One.")
        os.makedirs(blus30147_folder_path, exist_ok=True)
        return True
...
if successful_extraction:
    if build_patch_ark(False, rpcs3_directory, rpcs3_mode=True):
        ...
        # Copy files from _build/ps3 to rpcs3_directory/game/BLUS30147
        ...
        destination_dir = os.path.join(rpcs3_directory, "game", "BLUS30147")
        ...
        eboot_bin_path = os.path.join(rpcs3_directory, "game", "BLUS30147", "USRDIR", "eboot.bin")
