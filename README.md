...
- **A vanilla copy of Rock Band 2** for PS3 or Xbox 360 that you can extract onto your PC
...
First, **go to the [Releases](https://github.com/hmxmilohax/rock-band-2-deluxe/releases)** of this repo.
...
First, **extract your vanilla Rock Band 2 game disc** and place it in the `games` folder in your RPCS3 directory. ***Do NOT touch this folder once it's in `games`, Rock Band 2 Deluxe installs as a PS3 game update and installs in its own separate folder, shown below.***

Next, you will need the **latest update of Rock Band 2** installed on RPCS3. [Get it Here](http://b0.ww.np.dl.playstation.net/tppkg/np/BLUS30147/BLUS30147_T1/c8b8d16f692b3672/UP0006-BLUS30147_00-ROCKBAND2PATCH02-A0102-V0100-PE.pkg) and drag and drop it on top of the main RPCS3 window to install it.
...
First, you will need the **latest update of Rock Band 2** installed on your system. You can check for updates by inserting your disc, pressing `Triangle`, and selecting `Check for Update`. Update to version `1.02` if it asks you.
